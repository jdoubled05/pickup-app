...
// ── Fill these in ─────────────────────────────────────────────────────────────
const P8_KEY_PATH = "./secrets/AuthKey_94NNGGUW3A.p8"; // drop your .p8 file in the secrets/ folder
const TEAM_ID = "P544J98CK5"; // 10-char Apple Team ID
const KEY_ID = "94NNGGUW3A"; // Key ID shown in Apple Developer portal
const CLIENT_ID = "com.hardwoodstudio.pickup.auth"; // Services ID you created (e.g. com.simbasghost.pickup.auth)
// ─────────────────────────────────────────────────────────────────────────────
...
const header = b64url(
  Buffer.from(JSON.stringify({ alg: "ES256", kid: KEY_ID })),
);
...
console.log(
  "Paste the above into: Supabase → Auth → Providers → Apple → Secret Key\n",
);
